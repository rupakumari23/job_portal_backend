...
API_URL = "http://43.205.121.226:3000//api/project.all"
api_key = "lYoPoOewUVpocQkBNLYwrzxudOmgAddEHbBYzhSLtJiIGfKzPODtGOvuIFjDtIZx"
app_name = "job1portal-backend-lacxpd"
